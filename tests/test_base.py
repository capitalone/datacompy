...
def test_get_column_tolerance_exact_match():
    ...
    assert get_column_tolerance("col1", tol_dict) == pytest.approx(0.1)
    assert get_column_tolerance("col2", tol_dict) == pytest.approx(0.2)
